...
/*
 객체( Object ) : 하나의 독립되어 속성( 정적인 것 ), 기능( 동적인 것 )을 할 수 있는 대상
...
// 객체를 선언하는 방법
// var 객체이름 = { propertyName : propertyValue, method : function(){} };
...
(function(){
  ...
  /*
    전역 변수 사용하는 것처럼 사용하지 않고, 지역변수와 매개변수를 사용하는 방법으로
...
(function(){
  ...
  /*
   객체 Property에 객체 내부에서의 접근외에 다른 곳에서 직접 접근하는 것을 막지는 못함.
  => 막기 위해서는 다른 방법을 사용해야 한다.
  */
  car.name = 'Hyundai';
  car.printName();
